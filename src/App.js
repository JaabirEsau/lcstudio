  ...
  return (
    <div className="App">
      ...
      <div className="footer">
        <ul>
          <li><a href="https://www.facebook.com/" target="_blank"><i className="fa fa-facebook fa-fw" /></a></li>
          <li><a href="https://www.twitter.com/" target="_blank"><i className="fa fa-twitter fa-fw" /></a></li>
          
          <li><a href="https://www.linkedin.com/in/AMostafaH/" target="_blank"><i className="fa fa-linkedin fa-fw" /></a></li>
